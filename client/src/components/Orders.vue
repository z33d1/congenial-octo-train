...
export default {
  ...
  methods: {
      ...
      const path = window.location.hostname + ':' + process.env.VUE_APP_GW_PORT + '/user/' + this.user_id + '/order';
    ...
    removeOrder(orderID) {
      ...
      const path = window.location.hostname + ':' + process.env.VUE_APP_GW_PORT + '/user/' + this.user_id + '/order/' + orderID;
